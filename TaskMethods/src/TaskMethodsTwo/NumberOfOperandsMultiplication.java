...
public class NumberOfOperandsMultiplication {
    static void OperandsMultiplication(){
        ...
        if (num == 2){
            ...
            MethodMultiplication.Multiplication(a,b,c);
        }
        else if (num == 4) {
            System.out.print("Введите первое число: ");
            double a = in.nextDouble();
            ...
            MethodMultiplication.Multiplication(a,b,c,d);
        }
        else if (num == 5) {
            System.out.print("Введите первое число: ");
            double a = in.nextDouble();
            ...
            MethodMultiplication.Multiplication(a,b,c,d,e);
        }
    }
}